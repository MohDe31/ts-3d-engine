...
import { vec2Magnitude, vec2SqrMagnitude, Vec3, vec3Normal, vec3xNumMulR, vec3xVec3AddR, vec3xVec3SubR } from "../utils/vecUtils";
    ...
    update(){
        ...
        if(Mouse.GetKeyDown(2) && Mouse.lockStatus.Locked){
            ...
            if(!this.onFocus){
                ...
                this.camera.position = vec3xVec3AddR(vec3xNumMulR(dir, 10), this.whiteBall.position);
