...
export default class Mesh extends Component {
    ...
    updateTriangles(camera: Camera) {
        ...
        let center: Vec3, cameraDiff: Vec3;
        let dProduct: number;
        let norm: Vec3;
        ...
        for(let i = 0; i < this.triangles.length; i+=1) {
            ...
            triangle.normal = vec3Normal(norm);
            triangle.dProduct = dProduct;

            triangle.cameraPoints[0] = translated_1;
            triangle.cameraPoints[1] = translated_2;
            triangle.cameraPoints[2] = translated_3;
